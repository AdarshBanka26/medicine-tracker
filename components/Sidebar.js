  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-logo">
        ...
        <div className="sidebar-tagline">Circus Alchemists<br />Management Portal</div>
      </div>
      ...
      {/* Brew new elixir */}
      <Link href="/schedules/new" className="sidebar-brew-btn">
      ...
      <div className="sidebar-user">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: '12px', fontWeight: '600', color: '#fff', lineHeight: 1.2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {userName}
          </div>
          <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', marginTop: '1px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {userEmail}
          </div>
        </div>
