...
export async function sendMail({ subject, html }) {
  ...
  await transport.sendMail({
    from: `"Pillora" <${process.env.EMAIL_FROM}>`,
...
<div class="wrap">
  <div style="text-align:center;margin-bottom:24px;">
    ...
    <h1 class="gold" style="margin:8px 0 4px;font-size:1.4rem;letter-spacing:0.08em;">Pillora</h1>
    <p style="margin:0;color:#c9b88a;font-size:13px;">Your medication tracker</p>
  </div>
  ${bodyHtml}
  <div class="footer">
    <p>You are receiving this because you set up email reminders in Pillora.</p>
  </div>
</div>
</body>
</html>`;
